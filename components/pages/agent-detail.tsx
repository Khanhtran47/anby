		...
		<div className={cn('flex w-full flex-col gap-3', className)}>
			<Tabs className="flex w-full flex-col gap-3 sm:flex-row" defaultValue="general">
				...
				<div className="z-10 w-full gap-3 sm:w-1/2 sm:pb-24">
					<TabsContent forceMount className="mt-0 flex w-full flex-col gap-3" value="general">
					...
					<TabsContent forceMount className="mt-0 flex w-full flex-col gap-3" value="skills">
