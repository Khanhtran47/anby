...
>(({ className, inset, children, ...props }, ref) => (
	...
	>
		{children}
		<Icon className="ml-auto" name="chevron-right-bold" />
	</DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, active, ...props }, ref) => (
	<DropdownMenuPrimitive.Item
		...
		className={cn(
			...
			inset && 'pl-8',
			'active:animate-bg-gradient active:text-popover',
			active ? 'animate-bg-gradient text-popover' : null,
			className,
		)}
		{...props}
	/>
...
>(({ className, children, ...props }, ref) => (
	...
	>
		<span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
			<DropdownMenuPrimitive.ItemIndicator>
				<Icon className="h-2 w-2 fill-current" name="circle-bold" />
			</DropdownMenuPrimitive.ItemIndicator>
		</span>
		{children}
	</DropdownMenuPrimitive.RadioItem>
...
>(({ className, ...props }, ref) => (
	<DropdownMenuPrimitive.Separator
		ref={ref}
		className={cn('bg-border -mx-1 my-1 h-1', className)}
		{...props}
	/>
));
